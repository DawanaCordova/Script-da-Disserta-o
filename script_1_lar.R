...
#Como essa variável tem a categoria APTA E INAPTA terei que juntar 
...
#e o valor total. Esse valor total eu não sei o que 
#significa. 
...
#Aparece essa mensagem porque como eu disse, o qui-quadrado não é um teste  
